...
#Plot 1 - Global Active Power/freq
...
# set style
par(mfrow=c(1,1))
# create the histogram and label
hist(houseconsumption$Global_active_power, col = "red", main="Global Active Power",  xlab = "Global Active Power (kilowatts)", ylab = "Frequency")

#finish writing the file and close
dev.off()
# OUT PUT LOCATION
# files generated end up in same dir as the data
# getwd()
